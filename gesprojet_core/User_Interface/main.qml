...
ApplicationWindow {
    ...
    theme {
     ...
     property var projet: [
              "Ajouter Partenaire" ,"Liste Partenaire", "Ajouter Projet", "Liste Projet"
    ]

    property var association: [
            "Ajouter Association", "Liste Association","Liste Domaine", "Type Association"
    ]

    property var sections: [ association, projet ]

    property var sectionTitles: [ "Association", "Projet"]
